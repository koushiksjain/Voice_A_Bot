    ...
    while True:
        ...
        if ocr_text:
            ...
            if synthetic_text.strip():
                play_audio(synthetic_text, lang='kn')
            elif handwritten_text.strip():
                play_audio(handwritten_text, lang='kn')
            elif mnist_digits.strip():
                play_audio(mnist_digits, lang='kn')
